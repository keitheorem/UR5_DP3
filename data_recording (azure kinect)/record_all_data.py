...
class Data(): 
    ...
    def synchronized_capture(self, frequency=10):
        ...
        while True:
            ...
            if recording:
                ...
                # Get point_cloud
                point_cloud, color_image, depth_image = self.get_visual_obs()
                ...
                if robot_state is not None:
                    ...
                    # Save data
                    self.save_data(episode_folder, robot_state, action, point_cloud, color_image,depth_image)
                    print("loading")
    ...
    def save_data(self, episode_folder, robot_state, action, point_cloud, color_image, depth_image):
    ...
    def reshape_data(self, episode_folder):
        ...
        color_image = np.array(rgb_array)
